                        ...
                        <div class="p-6">
                            ...
                            <form method="POST" action="{{ route('orders.store') }}" id="orderForm">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="customer_name" class="w-full rounded-md border-gray-300">
                                </div>

                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Nomor Meja</label>
                                    <input type="text" name="table_number" class="w-full rounded-md border-gray-300">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="notes" rows="3" class="w-full rounded-md border-gray-300"></textarea>
                                </div>
