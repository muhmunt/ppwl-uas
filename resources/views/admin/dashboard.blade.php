                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $stats['total_orders_today'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">Rp {{ number_format($stats['total_revenue_today'], 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <a href="{{ route('categories.create') }}" class="inline-flex items-center justify-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:outline-none focus:border-green-700 focus:ring ring-green-300 active:bg-green-600 disabled:opacity-25 transition">
                            Tambah Kategori
                        </a>
